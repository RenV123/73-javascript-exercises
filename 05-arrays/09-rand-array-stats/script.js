...
(function() {
    ...
    document.getElementById("run").addEventListener("click", ()=> {
        ...
        for(let i = 0; i < 10; i++) {
            ...
            //Math.random returns a floating point nr between 0-1 :(
            // We will just scale it up to a 100 and see.
        ...
        document.getElementById("average").innerHTML = sumOfNrs / arrayOfNumbers.length;
