...
(function() {
    ...
    document.getElementById("run").addEventListener("click", function() {
        ...
        var visitorBirthDate = new Date();
        var currentDate = new Date(); //A new date is always today.
        ...
        var differenceInYears = currentDate.getFullYear() - visitorBirthDate.getFullYear();
